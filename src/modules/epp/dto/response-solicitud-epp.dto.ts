  ...
  static fromEntity(solicitud: any): ResponseSolicitudEppDto {
    ...
    dto.detalles = (solicitud.detalles || []).map((detalle: any) => {
      ...
      return {
        ...
        epp_nombre: detalle.eppNombreHistorico ?? detalle.epp?.nombre ?? '',
        epp_tipo_proteccion: detalle.eppTipoProteccionHistorico ?? detalle.epp?.tipoProteccion ?? '',
        epp_descripcion: detalle.eppDescripcionHistorica ?? detalle.epp?.descripcion ?? null,
        epp_vigencia: detalle.eppVigenciaHistorica ?? detalle.epp?.vigencia ?? null,
        epp_categoria_criticidad: detalle.epp?.categoriaCriticidad ?? null,
        epp_imagen_url: detalle.eppImagenUrlHistorica ?? detalle.epp?.imagenUrl ?? null,

...
export class ResponseTrabajadorDto {
  ...
  static fromEntity(t: {
    ...
    dto.numero_interior = (t as any).numeroInterior ?? null;
    dto.urbanizacion = (t as any).urbanizacion ?? null;
    dto.reside_en_lugar_trabajo = (t as any).resideEnLugarTrabajo ?? null;
    dto.tiempo_residencia_lugar_trabajo = (t as any).tiempoResidenciaLugarTrabajo ?? null;
    dto.estado_civil = (t as any).estadoCivil ?? null;
    dto.grado_instruccion = (t as any).gradoInstruccion ?? null;
    dto.nro_hijos_vivos = (t as any).nroHijosVivos ?? null;
    dto.nro_dependientes = (t as any).nroDependientes ?? null;
    dto.seguro_essalud = (t as any).seguroEssalud ?? null;
    dto.seguro_eps = (t as any).seguroEps ?? null;
    dto.seguro_sctr = (t as any).seguroSctr ?? null;
    dto.seguro_otro = (t as any).seguroOtro ?? null;
